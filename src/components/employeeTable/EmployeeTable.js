...
import {deleteEmployee, deleteGroupOfEmployee, getDeleteEmployeeInfo, getEmployees} from "../../actions/getEmployee";
...
const EmployeeTable = () => {
    ...
    const onDeleteGroupOfEmployee = () => {
        setConfirmDialogCommon({
            ...confirmDialogCommon,
            isOpen: false
        })
        dispatch(deleteGroupOfEmployee(selected, value, currentPageEmployee, rowsPerPage))
        setSelected([])
        setNotify({
            isOpen: true,
            message: 'Удалено успешно',
